...
window.MUSELAB_STRINGS = {
  zh: {
    ...
    "set.cost.claude_quota": "Claude 订阅额度",
    "set.cost.claude_quota_source": "Claude Agent SDK · 实时上报",
    "set.cost.claude_quota_empty": "还没有 Claude 订阅额度数据。发一条消息后 SDK 会上报当前用量窗口。",
    ...
    "onboard.welcome_step2": "打开会话顶栏的 Skills，选择 <code>archive-curator</code> 并点「试一下」；Muse 会通过对话帮你填写 <code>CLAUDE.md</code>",
  ...
  en: {
    ...
    "set.cost.claude_quota": "Claude subscription quota",
    "set.cost.claude_quota_source": "Claude Agent SDK · reported live",
    "set.cost.claude_quota_empty": "No Claude quota data yet. Send a message and the SDK reports the current usage windows.",
    ...
    "onboard.welcome_step2": "Open Skills in the chat header, choose <code>archive-curator</code>, and click \"Try this\"; Muse will fill <code>CLAUDE.md</code> with you through chat",

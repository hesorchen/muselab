...
window.MUSELAB_STRINGS = {
  zh: {
    ...
    "set.cost.cost_note": "$ — 表示该厂商不报告 USD 费用（DeepSeek / GLM / MiniMax），token 数准确；实际账单请去对应 console 查。",
    ...
    "onboard.welcome_step2": "点顶 bar 👤 按钮，让 Muse 通过对话帮你做一份档案——你回答它问的问题，它帮你写进 <code>CLAUDE.md</code>",
  ...
  en: {
    ...
    "set.cost.cost_note": "$ — means the vendor does not report USD (DeepSeek / GLM / MiniMax); token counts are accurate, check the vendor console for actual billing.",
    ...
    "set.skills.count": "Auto-detected {n} skills",
    ...
    "onboard.welcome_step2": "Click the 👤 button in the top bar — Muse will walk you through a quick conversational intake and save your profile into <code>CLAUDE.md</code>",

...
window.MUSELAB_STRINGS = {
  zh: {
    ...
    "msg.edit_hint": "编辑这条消息，从此点开新分支重发",
    "msg.edit_save": "保存并重发",
    "msg.edit_saving": "正在 fork...",
    "msg.edit_empty": "消息不能为空",
    "msg.edit_failed": "fork 失败：{err}",
    "msg.edit_done": "已切到新分支",
  ...
  en: {
    ...
    "msg.edit_hint": "Edit this message — forks a new branch from this point",
    "msg.edit_save": "Save & resend",
    "msg.edit_saving": "Forking…",
    "msg.edit_empty": "Message can't be empty",
    "msg.edit_failed": "Fork failed: {err}",
    "msg.edit_done": "Switched to the new branch",
